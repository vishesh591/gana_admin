...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (accountPageContainer) {
    ...
    let accountsData = [
      ...
      {
        id: 2,
        primaryLabelName: "Sony Music",
        labelName: "Sony Music India",
      ...
      {
        id: 4,
        primaryLabelName: "Zee Music",
        labelName: "Zee Music Company",
      ...
      {
        id: 5,
        primaryLabelName: "Saregama",
        labelName: "Saregama India Ltd",
    ...
    const newAccountModal = new bootstrap.Modal(
      document.getElementById("claimingRequestModal")
    );
    const exportCsvBtn = document.getElementById("exportCsvBtn");
    ...
    function updateSortIcons() {
      document
        .querySelectorAll(".sortable-header .sort-icon")
        .forEach((icon) => {
      ...
      if (activeHeader) {
        const activeIcon = activeHeader.querySelector(
          sortState.direction === "asc" ? ".bi-arrow-up" : ".bi-arrow-down"
        );

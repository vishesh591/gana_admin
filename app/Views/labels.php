  ...
  <div class="modal fade" id="createlabelModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <form id="createlabelForm" method="post" action="<?= site_url('add-labels') ?>">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <input type="text" name="label_name" class="form-control" id="labelName" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Primary Label Name</label>
              <input type="text" name="primary_label" class="form-control" id="primaryLabelName" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Email</label>
              <input type="email" name="email" class="form-control" id="labelEmail" required>
            </div>
            <div class="mb-3">
              <label class="form-label">Password</label>
              <input type="password" name="password" class="form-control" id="labelPassword" required>
            </div>
            <div class="mb-3">
              ...
              <input type="file" name="profile_image" id="imageInput" accept="image/*" style="display: none;" onChange="previewImage()">
            </div>
          </div>

                        ...
                        <table class="table table-hover mb-0" id="claimingTable">
                            ...
                            <tbody id="tableBody">
                                <tr>
                                    ...
                                    <td>
                                        <div class="release-title">
                                            <a href="#" class="view-details-link" data-bs-toggle="modal" data-bs-target="#releaseModal">Cosmic Drift</a>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="release-title">
                                            <a href="#" class="view-details-link" data-bs-toggle="modal" data-bs-target="#releaseModal">Neon Tides</a>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="release-title">
                                            <a href="#" class="view-details-link" data-bs-toggle="modal" data-bs-target="#releaseModal">Lost Signal</a>
                                        </div>
                                    ...
                                    <td>01:00-01:15</td>
                                    <td><span class="badge status-badge status-rejected">REJECTED</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content rounded-4">
             <form id="newClaimForm">
                <div class="modal-header"><h5 class="modal-title" id="newClaimRequestModalLabel">New Claiming Request Form</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
                <div class="modal-body p-4">
                    <div class="mb-3"><label for="songNameInput" class="form-label">Song Name</label><input type="text" class="form-control rounded-pill p-3" id="songNameInput" required></div>
                    <div class="mb-3"><label for="artistInput" class="form-label">Artist</label><input type="text" class="form-control rounded-pill p-3" id="artistInput" required></div>
                    <div class="mb-3"><label for="isrcInput" class="form-label">ISRC</label><input type="text" class="form-control rounded-pill p-3" id="isrcInput" required></div>
                    <div class="mb-3"><label for="instagramAudioInput" class="form-label">Instagram Audio Link</label><input type="url" class="form-control rounded-pill p-3" id="instagramAudioInput" placeholder="https://..." required></div>
                    <div class="mb-3"><label for="reelMergeInput" class="form-label">Reel Merge Link</label><input type="url" class="form-control rounded-pill p-3" id="reelMergeInput" placeholder="https://..." required></div>
                    <div class="mb-3"><label for="matchingTimeInput" class="form-label">Matching Time</label><input type="text" class="form-control rounded-pill p-3" id="matchingTimeInput" placeholder="e.g., 00:15-00:45" required></div>
                </div>
                <div class="modal-footer"><button type="button" class="btn btn-secondary rounded-pill" data-bs-dismiss="modal">Close</button><button type="submit" class="btn btn-primary rounded-pill">Submit Request</button></div>
            </form>
        </div>
    </div>
</div>

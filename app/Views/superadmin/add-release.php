    ...
    <div class="content">
        <div class="container-xxl">
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column justify-content-between">
                ...
                <div class="d-flex gap-2">
                    ...
                    <?php if (isset($isEdit) && $isEdit && isset($release)): ?>
                        ...
                        $hasRejectionMessages = false;
                        if (
                            (isset($release['message']) && !empty($release['message']))
                            && (isset($release['status']) && $release['status'] == "4")
                        ) {
                            $hasRejectionMessages = true;
                        }
                        ?>

                        <?php if ($hasRejectionMessages): ?>
            ...
            <form id="releaseForm" action="<?= $formAction ?>" method="<?= $formMethod ?>" enctype="multipart/form-data" novalidate>
                ...
                <input type="hidden" id="draftId" name="draft_id" value="<?= isset($draft['id']) ? $draft['id'] : '' ?>">
                <input type="hidden" id="releaseId" name="release_id" value="<?= isset($release['id']) ? $release['id'] : '' ?>">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="releaseTitle" name="releaseTitle" value="<?= isset($release) ? esc($release['title']) : '' ?>" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <?php if (in_array($user['role_id'], [1, 2])): ?>
                                    ...
                                    <select class="form-select searchable-select" id="labelName" name="label_id" required data-placeholder="Search and select a label...">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="release-type-container">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="releaseType" id="single" value="single" <?= (!isset($release) || $release['release_type'] == 'single') ? 'checked' : '' ?> required>
                                        <label class="form-check-label" for="single">Single</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="releaseType" id="ep" value="ep" <?= (isset($release) && $release['release_type'] == 'ep') ? 'checked' : '' ?> required>
                                        <label class="form-check-label" for="ep">EP</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="releaseType" id="album" value="album" <?= (isset($release) && $release['release_type'] == 'album') ? 'checked' : '' ?> required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="genre" name="genre" required>
                                    ...
                                    <?php foreach ($genres as $genre): ?>
                                        <option value="<?= esc($genre['name']) ?>" <?= (isset($release) && $release['genre_type'] == $genre['name']) ? 'selected' : '' ?>>
                                            <?= esc($genre['name']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="upcEan" name="upcEan" value="<?= isset($release) ? esc($release['upc_ean']) : '' ?>" placeholder="Optional">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="language" name="language" required>
                                    ...
                                    <?php foreach ($languages as $lang): ?>
                                        <option value="<?= esc($lang['name']) ?>" <?= (isset($release) && $release['language'] == $lang['name']) ? 'selected' : '' ?>>
                                            <?= esc($lang['name']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="trackTitle" name="trackTitle" value="<?= isset($release) ? esc($release['track_title']) : '' ?>" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="instrumental" id="instrumentalYes" value="yes" <?= (isset($release) && $release['instrumental'] == 'yes') ? 'checked' : '' ?> required>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="author" name="author" value="<?= isset($release) ? esc($release['author']) : '' ?>" placeholder="Comma separated names" required>
                                <div class="invalid-feedback">Please provide the author's names.</div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="composer" class="form-label required-field">Composer</label>
                                <input type="text" class="form-control" id="composer" name="composer" value="<?= isset($release) ? esc($release['composer']) : '' ?>" placeholder="Comma separated names" required>
                                <div class="invalid-feedback">Please provide the composer's names.</div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="remixer" name="remixer" value="<?= isset($release) ? esc($release['remixer']) : '' ?>" placeholder="Comma separated names">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="arranger" class="form-label">Arranger</label>
                                <input type="text" class="form-control" id="arranger" name="arranger" value="<?= isset($release) ? esc($release['arranger']) : '' ?>" placeholder="Comma separated names">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="producer" name="producer" value="<?= isset($release) ? esc($release['music_producer']) : '' ?>" placeholder="Comma separated names">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="publisher" class="form-label">Publisher</label>
                                <input type="text" class="form-control" id="publisher" name="publisher" value="<?= isset($release) ? esc($release['publisher']) : '' ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="cLineYear" name="cLineYear" value="<?= isset($release) ? esc($release['c_line_year']) : '' ?>" required placeholder="Enter year">
                                <div class="invalid-feedback">Please enter a © Line Year.</div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="cLine" class="form-label">© Line</label>
                                <input type="text" class="form-control" id="cLine" name="cLine" value="<?= isset($release) ? esc($release['c_line']) : '' ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="pLineYear" class="form-label required-field">℗ Line Year</label>
                                <input type="number" class="form-control" id="pLineYear" name="pLineYear" value="<?= isset($release) ? esc($release['p_line_year']) : '' ?>" required placeholder="Enter year">
                                <div class="invalid-feedback">Please enter a ℗ Line Year.</div>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="pLine" class="form-label">℗ Line</label>
                                <input type="text" class="form-control" id="pLine" name="pLine" value="<?= isset($release) ? esc($release['p_line']) : '' ?>">
                            </div>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="store-checkbox-group" id="rightsStores">
                                ...
                                <div class="store-checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="rights1" name="rights[]" value="youtubeid" <?= in_array('youtubeid', $selectedRights) ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="rights1">YouTube Content ID</label>
                                    </div>
                                </div>
                                <div class="store-checkbox-item">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="rights2" name="rights[]" value="facebook" <?= in_array('facebook', $selectedRights) ? 'checked' : '' ?>>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="releaseDate" name="release_date" value="<?= isset($release) ? $release['release_date'] : '' ?>" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="preSaleDate" name="pre_sale_date" value="<?= isset($release) ? $release['pre_sale_date'] : '' ?>">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" class="form-control" id="originalReleaseDate" name="original_release_date" value="<?= isset($release) ? $release['original_release_date'] : '' ?>" required>
                ...
                <div class="step-content" id="step-5">
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="contentGuidelines" name="content_guidelines" <?= (!isset($isEdit) || !$isEdit) ? 'required' : '' ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="isrcGuidelines" name="isrc_guidelines" <?= (!isset($isEdit) || !$isEdit) ? 'required' : '' ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="youtubeGuidelines" name="youtube_guidelines" <?= (!isset($isEdit) || !$isEdit) ? 'required' : '' ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="audioStoreGuidelines" name="audio_store_guidelines" <?= (!isset($isEdit) || !$isEdit) ? 'required' : '' ?>>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="rejectionMessage" name="rejectionMessage" rows="5" placeholder="Please provide a detailed reason for rejecting this release. This message will be sent to the user." maxlength="1000" required></textarea>
                    <div class="form-text">
...
<!-- Rejection Messages Modal (for viewing existing rejections) -->
        ...
        <div class="modal-content">
            <div class="modal-header bg-warning text-dark">
                <h5 class="modal-title" id="rejectionMessagesModalLabel">
                    <i data-feather="message-square" class="me-2"></i>Rejection Messages
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div id="rejectionMessagesContent">
                    <!-- Content will be loaded here -->
                    <div class="text-center p-4">
                        <div class="spinner-border text-primary" role="status">
                            <span class="visually-hidden">Loading...</span>
                        </div>
                        <p class="mt-2 text-muted">Loading rejection messages...</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
    <div id="draftSuccessToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        <div class="toast-body">
            Your release has been saved as draft successfully!
        </div>
    </div>
</div>

    ...
    <div class="offcanvas-body">
        <form id="facebookConflictForm" novalidate>
            ...
            <div id="formStepInReview" class="form-step d-none">
                <div class="p-3 rounded mb-4 album-section-card d-flex align-items-center" style="background-color: #f8f9fa;">
                    <img src="https://placehold.co/80x80/3b5998/ffffff?text=FB" class="album-cover rounded" id="modalAlbumCoverInReview" alt="Album Art" style="width: 60px; height: 60px;">
                    <div class="ms-3">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="p-2 bg-light rounded" style="max-height: 200px; overflow-y: auto;">
                            <pre class="mb-0 small" id="resolutionCountries">Loading...</pre>
                        </div>
                    </div>

                ...
                <div class="modal-body p-4">
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <label for="storeCategory" class="form-label">StoreCategory</label>
                            <input type="text" class="form-control rounded-pill p-3" id="storeCategory" value="Instagram / Facebook Reels" readonly>
                        </div>
                        <div class="col-md-6 mb-4">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control rounded-pill p-3" id="artistAssetId" value="Orion Sun / 987654321" readonly>
                        </div>
                        <div class="col-md-6 mb-4">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control rounded-pill p-3" id="otherParty" value="Stardust Records LLC" readonly>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label for="dailyViews" class="form-label">Daily Views</label>
                            <input type="text" class="form-control rounded-pill p-3" id="dailyViews" value="1.2M" readonly>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label for="expiry" class="form-label">Expiry</label>
                            <input type="text" class="form-control rounded-pill p-3" id="expiry" value="31-12-2026" readonly>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label for="status" class="form-label">Status</label>
                            <input type="text" class="form-control rounded-pill p-3" id="status" value="Pending Review" readonly>
                        </div>
                    </div>
                </div>

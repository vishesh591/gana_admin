...
class CreateFacebookConflictsTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'status'                                => ['type' => 'VARCHAR', 'constraint' => 50, 'null' => true, 'default' => 'Action Required'],
            'resolution_rights_owned'               => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'resolution_date'                       => ['type' => 'DATETIME', 'null' => true],
            'supporting_document_path'              => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],

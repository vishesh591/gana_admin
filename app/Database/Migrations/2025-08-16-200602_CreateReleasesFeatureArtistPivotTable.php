...
class CreateReleaseFeaturingArtistsTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->createTable('release_featuring_artists');
    }

    public function down()
    {
        $this->forge->dropTable('release_featuring_artists');
    }
}
